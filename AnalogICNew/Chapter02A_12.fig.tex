...
\draw[fill=mnmN0] (xPLpy|-yA) {[rounded corners=0.03cm]  -- (xPLpy|-yLDD) -- (xPLb|-yLDD) -- (xPLb|-yA)} -- cycle;

\draw[fill=mnmN0] (xPRpy|-yA) {[rounded corners=0.03cm]  -- (xPRpy|-yLDD) -- (xPRb|-yLDD) -- (xPRb|-yA)} -- cycle;

\draw[fill=mnmP0] (xNLpy|-yA) {[rounded corners=0.03cm]  -- (xNLpy|-yLDD) -- (xNLb|-yLDD) -- (xNLb|-yA)} -- cycle;

\draw[fill=mnmP0] (xNRpy|-yA) {[rounded corners=0.03cm]  -- (xNRpy|-yLDD) -- (xNRb|-yLDD) -- (xNRb|-yA)} -- cycle;

\draw[fill=mnmLig] (xWb|-yA) rectangle (xWc|-yLIG);
...
\foreach \x in {0.02,0.06,...,0.98}
{
    \draw[-latex] ($(xL|-yIMPa)!\x!(xR|-yIMPa)$) -- ($(xL|-yIMPb)!\x!(xR|-yIMPb)$);
}

\path (xC|-yIMPa) node[above=0.25cm] {$n^{+}$ S/D implantation};
