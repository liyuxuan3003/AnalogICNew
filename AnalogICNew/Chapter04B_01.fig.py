...
MPLDrawPoints(d["VID"],d["ISS"],[iM5s],"k","w",4)
MPLDrawPoints(d["VID"],d["ID2"],[iM2o],"k","w",4)
...
plt.figure(idM[2])
MPLDrawPoints(d["VID"],d["VGT2"],[iM2o,iM2s],"k","w",4)

plt.figure(idM[4])
MPLDrawPoints(d["VID"],d["VGT4"],[iM4s],"k","w",4)
