...
\draw[fill=mnmP3] (xL|-yS) rectangle (xR|-yA);
...
\draw[fill=mnmSiO2] (xL|-yA) rectangle (xR|-yOA);
\draw[fill=mnmSiO2] (xL|-yOA) rectangle (xR|-yOB);
\draw[fill=mnmSi3N4] (xL|-yOB) rectangle (xR|-yPro);
...
\draw[fill=mnmTiSi2] (xPLa|-yA) rectangle (xPLsw|-yMSIb);
\draw[fill=mnmTiSi2] (xPRa|-yA) rectangle (xPRsw|-yMSIb);
\draw[fill=mnmTiSi2] (xPLpy|-yPoly) rectangle (xPRpy|-yMSIa);

\draw[fill=mnmTiSi2] (xNLa|-yA) rectangle (xNLsw|-yMSIb);
\draw[fill=mnmTiSi2] (xNRa|-yA) rectangle (xNRsw|-yMSIb);
\draw[fill=mnmTiSi2] (xNLpy|-yPoly) rectangle (xNRpy|-yMSIa);

\draw[fill=mnmW] (xLbPD|-yMSIb) -- (xLaPD|-yOA) -- (xRaPD|-yOA) -- (xRbPD|-yMSIb) -- cycle;
\draw[fill=mnmW] (xLbPS|-yMSIb) -- (xLaPS|-yOA) -- (xRaPS|-yOA) -- (xRbPS|-yMSIb) -- cycle;
\draw[fill=mnmW] (xLbND|-yMSIb) -- (xLaND|-yOA) -- (xRaND|-yOA) -- (xRbND|-yMSIb) -- cycle;
\draw[fill=mnmW] (xLbNS|-yMSIb) -- (xLaNS|-yOA) -- (xRaNS|-yOA) -- (xRbNS|-yMSIb) -- cycle;

\draw[fill=mnmAl] (xL|-yOA) rectangle (xPLsw|-yMA);
\draw[fill=mnmAl] (xR|-yOA) rectangle (xNRsw|-yMA);

\draw[fill=mnmAl] (xPRa|-yOA) rectangle (xPRsw|-yMA);
\draw[fill=mnmAl] (xNLa|-yOA) rectangle (xNLsw|-yMA);

\draw[fill=mnmW] (xLbP|-yMA) -- (xLaP|-yOB) -- (xRaP|-yOB) -- (xRbP|-yMA) -- cycle;
\draw[fill=mnmW] (xLbN|-yMA) -- (xLaN|-yOB) -- (xRaN|-yOB) -- (xRbN|-yMA) -- cycle;

\draw[fill=mnmAl] (xWa|-yOB) rectangle (xWc|-yMB);
