...
\draw[fill=mnmLig] (xL|-yA) rectangle (xWa|-yLIG);
\draw[fill=mnmLig] (xR|-yA) rectangle (xWb|-yLIG); 
\draw[fill=mnmSiO2] (xL|-yA) rectangle (xR|-ySiO);
...
\path (xC|-yIMPa) node[above=0.25cm] {$p$ well implantation};
