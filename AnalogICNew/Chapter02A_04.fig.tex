...
\draw[fill=mnmSi3N4] (xL|-ySiO) rectangle (xR|-ySiN);

\draw[fill=mnmP2] (xWb|-yA) -- (xWb|-yO) {[rounded corners] -- (xWb|-yW) -- (xWa|-yW)} -- (xWa|-yO) -- (xWa|-yA) -- cycle;

\draw[fill=mnmN2] (xWb|-yA) -- (xWb|-yO) {[rounded corners] -- (xWb|-yW) -- (xWc|-yW)} -- (xWc|-yO) -- (xWc|-yA) -- cycle;
